package com.sherry.coolweather;
...
import com.sherry.coolweather.gson.Forecast;
import com.sherry.coolweather.gson.Weather;
import com.sherry.coolweather.util.HttpUtil;
import com.sherry.coolweather.util.Utility;
...
public class WeatherActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        comfortText = (TextView) findViewById(R.id.cpmfort_text);
    ...
    private void requestWeather(final String weatherId){
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId +
                "&key=40eea0b2a5574a8eb0c88cd605258f71";
    ...
    private void showWeatherInfo(Weather weather){
        ...
        for(Forecast forecast : weather.forecastList) {
            ...
            TextView mixText = (TextView) findViewById(R.id.min_text);
